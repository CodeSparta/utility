...
tar -czf tar-bundles/sparta-utility.tar.gz ansible-roles tar-bundles/utility.tar tar-bundles/mirror-registry.tar.gz tar-bundles/oc-mirror.tar.gz tar-bundles/openshift-client-linux.tar.gz tar-bundles/openshift-install-linux.tar.gz
